...
import 'package:nagot_ui/widgets/home_body_widget.dart';
import 'package:nagot_ui/widgets/transaction_widget.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: ImageIcon(
              const AssetImage("assets/ic_home_active.png"),
              color: item1color,
              size: 24,
            ),
            label: 'Home',
          ...
          BottomNavigationBarItem(
            icon: ImageIcon(
              const AssetImage("assets/ic_transactions_active.png"),
              color: item2color,
              size: 24,
            ),
            label: 'Transaction',
          ...
          BottomNavigationBarItem(
            icon: ImageIcon(
              const AssetImage("assets/ic_people.png"),
              color: item3color,
              size: 24,
            ),
            label: 'Contacts',
          ...
          BottomNavigationBarItem(
            icon: ImageIcon(
              const AssetImage("assets/ic_my_nagad.png"),
              color: item4color,
              size: 24,
            ),
            label: 'My Nagad',
