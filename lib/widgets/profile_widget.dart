...
import 'package:nagot_ui/models/profile_item.dart';
import 'package:nagot_ui/widgets/profile_item_widget.dart';
...
List<ProfileItem> generalList = [
  ProfileItem(
      ...
      title: "Language",
      endWidget: const Text("English")),
  ProfileItem(
      icon: "assets/ic_account_type.png",
      title: "Account Type",
      endWidget: const Text("Regular")),
  ProfileItem(
      icon: "assets/ic_profit.png",
      title: "I Want Profit",
      endWidget: const Text("NO")),
  ProfileItem(
  ...
  ProfileItem(
      icon: "assets/ic_mno.png",
      title: "Change Mobile Operator",
      endWidget: const Icon(
        Icons.arrow_forward_ios_sharp,
        color: Colors.grey,
      )),
  ProfileItem(
      icon: "assets/ic_kyc_icon.png",
      title: "Re-submit KYC",
      endWidget: const Icon(
        Icons.arrow_forward_ios_sharp,
        color: Colors.grey,
  ...
  ProfileItem(
      icon: "assets/ic_merchant_list.png",
...
List<ProfileItem> moreInfoList = [
  ...
  ProfileItem(
      icon: "assets/ic_storelocator.png",
      title: "Store Locator",
      endWidget: const Icon(
        Icons.arrow_forward_ios_sharp,
        color: Colors.grey,
                      ...
                      children: [
                        Padding(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage:
                                const AssetImage('assets/anonymous.png'),
                          ),
                        ),
